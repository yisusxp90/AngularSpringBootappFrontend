...
const appRoutes: Routes = [
  ...
  { path: 'usuarios/page/:page', component: UsuariosComponent, canActivate: [AuthGuard], data: { role: 'ROLE_ADMIN' } },
  { path: 'usuarios/:page/:id', component: RegistroComponent, canActivate: [AuthGuard, RoleGuard], data: { role: 'ROLE_ADMIN' } },
  ];
